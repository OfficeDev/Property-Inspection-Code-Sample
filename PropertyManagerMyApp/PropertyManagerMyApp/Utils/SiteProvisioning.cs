...
namespace SuiteLevelWebApp.Utils
{
    public class SiteProvisioning
    {
        ...
        private readonly string[] _siteColumns = {
            ...
            "<Field DisplayName='Inspector ID' Description='' Name='sl_inspectorID' ID='{aaf8ed5b-30d8-400d-ac14-50b9811d7d56}' Group='Suite Level App Columns' Type='Lookup'/>",
            "<Field DisplayName='Inspector' Description='' Name='sl_inspector' ID='{347cba7a-8cab-40fd-822b-c36c9bf7d4fb}' Group='Suite Level App Columns' Type='Lookup'/>",
            ...
            "<Field DisplayName='Repair Person' Description='' Name='sl_repairPerson' ID='{f04884c1-7296-48c5-9720-b6944ce72eb4}' Group='Suite Level App Columns' Type='Lookup'/>",
        ...
        public void AddSiteComponents()
        {
            ...
            // Create Content Type "Repair Person" and List "Repair People"
            CSOMUtil.CreateContentType(_clientContext, "Repair Person", "", "0x0100EF599D47A3D2409193AC8276BE6DECB8", new string[] { 
                "sl_accountname", 
                "sl_emailaddress" 
            });
            CSOMUtil.AddSharePointList(_clientContext, "0x0100EF599D47A3D2409193AC8276BE6DECB8", "Repair People", "Lists/RepairPeople", (int)ListTemplateType.GenericList);

            // Create Content Type "Inspector" and List "Inspectors"
            CSOMUtil.CreateContentType(_clientContext, "Inspector", "", "0x0100D2E3A1E1221041048FCCF4ACA70716FC", new string[] { 
                "sl_accountname", 
                "sl_emailaddress" 
            });
            CSOMUtil.AddSharePointList(_clientContext, "0x0100D2E3A1E1221041048FCCF4ACA70716FC", "Inspectors", "Lists/Inspectors", (int)ListTemplateType.GenericList);
            ...
            CSOMUtil.BindLookupField(_clientContext, "Inspections", "sl_inspector", "Title", "Inspectors");
            ...
            CSOMUtil.BindLookupField(_clientContext, "Incidents", "sl_repairPerson", "Title", "Repair People");
        ...
        {
            //Delete lists
            CSOMUtil.RemoveSharePointList(_clientContext, "Repair People");
            CSOMUtil.RemoveSharePointList(_clientContext, "Inspectors");
        ...
        public void AddSiteContents()
        {
            ...
            //add items to RepairPeople list
            CSOMUtil.AddListItems(_clientContext, "Repair People", sampleData);

            //add items to Inspectors list
            CSOMUtil.AddListItems(_clientContext, "Inspectors", sampleData);
