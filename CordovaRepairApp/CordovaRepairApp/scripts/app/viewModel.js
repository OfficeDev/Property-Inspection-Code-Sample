var viewModel = {
    ...
    incidentListsView: {
        ...
        IncidentItemClick: function (index) {
            //incidentCtrl.uploadImage(this.ImageUrl());
    ...
    incidentItem: function (objData) {
        ...
        this.TaskId = ko.observable(objData["sl_taskId"]);
        this.CompletedDate = ko.observable(rpUtil.getTimeString(inspectionData["sl_repairCompleted"]));
        this.InspectorNmae = ko.observable(inspectionData["sl_inspector"]);
        this.InspectorEmail = ko.observable(inspectionData["sl_emailaddress"]);*/
    },
