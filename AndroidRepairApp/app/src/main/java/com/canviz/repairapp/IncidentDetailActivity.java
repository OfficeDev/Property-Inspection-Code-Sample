...
import com.canviz.repairapp.utility.EmailHelper;
...
import com.microsoft.graph.odata.UserFetcher;
    ...
    private void sendEmailAfterRepairCompleted() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                final com.microsoft.graph.Message message = new com.microsoft.graph.Message();
                ...
                try {
                    ...
                    ADALDependencyResolver resolver = new ADALDependencyResolver(
                    ...
                    GraphServiceClient graphServiceClient = new GraphServiceClient(url, resolver);
