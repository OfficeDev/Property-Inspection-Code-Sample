    ...
    public class O365SiteProvisioningController : Controller
    {
                    ...
                    case "None":
                        try
                        {
                            CSOMUtil.CreateSiteCollection(adminClientContext, new SiteCreationProperties
                            {
                                ...
                                StorageMaximumLevel = 2000,
                                StorageWarningLevel = 1750,
                                TimeZoneId = 7,
                                UserCodeMaximumLevel = 5000,
                                UserCodeWarningLevel = 4000
                            });
        ...
        public async Task<ActionResult> ProvisionSiteComponents()
        {
            ...
            using (var clientContext = TokenHelper.GetClientContextWithAccessToken(DemoSiteCollectionUrl, token))
            {
                ...
                ViewBag.Message = "The demo site collection has been created successfully.";
            }
            return View();
        }

        public ActionResult ProvisionDemoData(string Message)
        {
        ...
        public async Task<ActionResult> CreateDemoData()
        {
            ...
            using (var clientContext = TokenHelper.GetClientContextWithAccessToken(DemoSiteCollectionUrl, token))
            {
                ...
                return RedirectToAction("ProvisionDemoData", new { Message = "The demo data has been created successfully." });
            }
        }
        ...
        public async Task<ActionResult> ProvisionWorkflowPost()
        {
            ...
            using (var clientContext = TokenHelper.GetClientContextWithAccessToken(DemoSiteCollectionUrl, token))
            {
                ...
                ViewBag.Message = "Incident Workflow, Incident Workflow Tasks list and Incident Workflow History list have been created successfully.";
            }
            return View();
        }
